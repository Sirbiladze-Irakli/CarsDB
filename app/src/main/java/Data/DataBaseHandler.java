...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CARS_TABLE = "CREATE TABLE " + Util.TABLE_NAME + "(" + Util.KEY_ID + " INTEGER " +
                "PRIMARY KEY, " + Util.KEY_NAME + " TEXT, " + Util.KEY_PRICE + " TEXT)";
    ...
    public void addCar(Car car) {
        ...
        contentValues.put(Util.KEY_PRICE, car.getPrise());
    ...
    public List<Car> getAllCars() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                car.setPrise(cursor.getString(2));
